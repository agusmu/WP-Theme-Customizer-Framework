...
add_filter( 'cw_sanitize_dropdown-pages', 'cw_sanitize_pages' );

function cw_sanitize_pages($input) {
		global $allowedposttags;
...
/* Uploader */
add_filter( 'cw_sanitize_image', 'cw_sanitize_upload' );
add_filter( 'cw_sanitize_file', 'cw_sanitize_upload' );
